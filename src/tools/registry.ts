/**
 * Tool registry for Philippine Law MCP Server.
...
import { getPhilippineImplementations, type GetPhilippineImplementationsInput } from './get-philippine-implementations.js';
...
const LIST_SOURCES_TOOL: Tool = {
  ...
  description:
    ...
    'including the Federal Register of Legislation (Philippine Government, Office of Parliamentary Counsel). ' +
    ...
    'Call this FIRST when you need to understand what Philippine legal data this server covers.',
  inputSchema: { type: 'object', properties: {} },
};
...
export const TOOLS: Tool[] = [
  {
    ...
    description:
      'Search Philippine statutes and regulations by keyword using full-text search (FTS5 with BM25 ranking). ' +
  ...
  },
  {
    name: 'get_provision',
    description:
      'Retrieve the full text of a specific provision (section) from an Philippine statute. ' +
  ...
  },
  {
    ...
    description:
      'Validate an Philippine legal citation against the database — zero-hallucination check. ' +
  ...
  },
  {
    ...
    description:
      'Build a comprehensive set of citations for a legal question by searching across all Philippine statutes simultaneously. ' +
      'Returns aggregated results from multiple relevant provisions, useful for legal research on a topic. ' +
      'Use this for broad legal questions like "What are the penalties for data breaches in Philippines?" ' +
  ...
  },
  {
    ...
    description:
      'Format an Philippine legal citation per standard conventions. ' +
  ...
  },
  {
    name: 'check_currency',
    description:
      'Check whether an Philippine statute or provision is currently in force, amended, repealed, or not yet in force. ' +
  ...
  },
  {
    name: 'get_eu_basis',
    description:
      'Get the EU legal basis that an Philippine statute references or aligns with. ' +
      'Philippines is not an EU member but Philippine laws may reference EU directives/regulations ' +
    ...
    inputSchema: {
      type: 'object',
      properties: {
        document_id: { type: 'string', description: 'Philippine statute identifier.' },
        include_articles: {
          type: 'boolean',
  ...
  {
    name: 'get_philippine_implementations',
    description:
      'Find all Philippine statutes that reference or align with a specific EU directive or regulation. ' +
      'Given an EU document ID (e.g., "regulation:2016/679" for GDPR), returns matching Philippine statutes. ' +
      'Note: Philippines does not transpose EU law but may reference or align with EU frameworks voluntarily.',
    inputSchema: {
      type: 'object',
      properties: {
        eu_document_id: {
  ...
  },
  {
    ...
    description:
      'Search for EU directives and regulations that are referenced by Philippine legislation. ' +
    ...
    inputSchema: {
      ...
      properties: {
        ...
        has_philippine_implementation: {
          type: 'boolean',
          description: 'If true, only return EU documents referenced by Philippine legislation.',
        },
  ...
  },
  {
    ...
    description:
      'Get the EU legal basis for a SPECIFIC provision within an Philippine statute. ' +
  ...
  },
  {
    ...
    description:
      'Check EU alignment status for an Philippine statute or provision. ' +
      ...
      'Note: Philippines is not bound by EU law; this checks voluntary alignment and cross-references.',
    inputSchema: {
      type: 'object',
      properties: {
        document_id: { type: 'string', description: 'Philippine statute identifier.' },
    ...
    try {
      ...
      switch (name) {
        ...
        case 'get_eu_basis':
          ...
          break;
        case 'get_philippine_implementations':
          result = await getPhilippineImplementations(db, args as unknown as GetPhilippineImplementationsInput);
          break;
